# video_360p.mp4_secure=Fw5szIka3hiD5SqWJGzIGQ==,1782067351
...
| ویژگی | مقدار |
|-------|-------|
| **نام فایل** | `video_360p.mp4_secure=Fw5szIka3hiD5SqWJGzIGQ==,1782067351` |
| **حجم کل** | 60.09 MB (1 پارت) |
| **وضعیت** | **Complete** |
| **رمز عبور** | **خیر** |
...
| # | فایل | لینک |
|---|------|------|
| 1 | `video_360p_5721.rar` | [دانلود](https://github.com/GordonFreeman-BM/UDL-3/raw/main/downloads/video_360p_5721/video_360p_5721.rar) |
